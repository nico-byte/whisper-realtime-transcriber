...
def mock_whisper_model():
    with patch("transformers.WhisperForConditionalGeneration") as mock_model_class, patch(
...
async def test_transcribe(mock_inputstream_generator, mock_whisper_model):
    ...
    whisper_model = WhisperModel(inputstream_generator=mock_inputstream_generator, continuous=False, verbose=False)
...
async def test_run_inference_continuous(mock_inputstream_generator, mock_whisper_model):
    ...
    whisper_model = WhisperModel(inputstream_generator=mock_inputstream_generator, continuous=True, verbose=False)
